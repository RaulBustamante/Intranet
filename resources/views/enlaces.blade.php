...
<head>
    ...
    <title>Accesos Rápidos - Intranet Ariel</title>
...
<main>
        <section class="quick-links">
            ...
            <a href="http://192.168.1.228:3000" target="_blank" class="quick-link-card">
                ...
                <div class="quick-link-text">
                    <h3>Metabase</h3>
                    <p>Aplicación de visualización de datos.</p>
                </div>
            </a>
            <a href="https://arielpremiumsupply.monday.com" target="_blank" class="quick-link-card">
                ...
                <div class="quick-link-text">
                    <h3>Monday</h3>
                    <p>Plataforma de administración de proyectos.</p>
                </div>
            </a>
            ...
            <a href="https://www.sodexo.es/pluxee/" target="_blank" class="quick-link-card">
                ...
                <div class="quick-link-text">
                    <h3>Sodexo - Pluxee</h3>
                    <p>Tarjetas de Vales de despensa.</p>
                </div>
            </a>
            <a href="https://www.trello.com" target="_blank" class="quick-link-card">
                ...
                <div class="quick-link-text">
                    <h3>Trello</h3>
                    <p>Plataforma para administrar.</p>
                </div>
            </a>
            ...
            <a href="http://192.168.1.222" target="_blank" class="quick-link-card">
                ...
                <div class="quick-link-text">
                    ...
                    <p>Registro de entrada digital.</p>
                </div>
            </a>
...
document.addEventListener('DOMContentLoaded', function () {
    console.log('Quick Links page loaded');
});
