...
<div class="sidebar">
    <a href="{{ url('/calendar') }}" class="menu-item" data-tooltip="Noticias"><i class="fas fa-newspaper"></i></a>
    <a href="{{ url('/calendar') }}" class="menu-item" data-tooltip="Nuevos miembros"><i class="fas fa-user-friends"></i></a>
    <a href="{{ url('/calendar') }}" class="menu-item" data-tooltip="Calendario"><i class="fas fa-calendar-alt"></i></a>
    <a href="{{ url('/calendar') }}" class="menu-item" data-tooltip="Galeria"><i class="fas fa-image"></i></a>
    <a href="{{ url('/calendar') }}" class="menu-item" data-tooltip="Cumpleañeros"><i class="fas fa-birthday-cake"></i></a>
    <a href="{{ url('/calendar') }}" class="menu-item" data-tooltip="Nuestra historia"><i class="fas fa-book"></i></a>
    <a href="{{ url('/calendar') }}" class="menu-item" data-tooltip="Nomina"><i class="fas fa-wallet"></i></a>
    <a href="{{ url('/calendar') }}" class="menu-item" data-tooltip="Recursos Humanos"><i class="fas fa-users"></i></a>
    <a href="{{ url('/calendar') }}" class="menu-item" data-tooltip="Documentos"><i class="fas fa-file-alt"></i></a>
</div>
